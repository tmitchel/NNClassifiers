...
#sig_tree = uproot.open('~/private/higgsToTauTau/ltau_analyzer/CMSSW_9_4_0/src/ltau_analyzers/Output/trees/mutau2016_official_v1p3_NNed/ggh_madgraph_twojet.root')['mutau_tree']
sig= read_root('~/private/higgsToTauTau/ltau_analyzer/CMSSW_9_4_0/src/ltau_analyzers/Output/trees/mutau2016_official_v1p3_NNed/vbf_inc.root', columns=['NN_disc', 'm_sv'])

#sig = sig_tree.pandas.df(['NN_disc', 'm_sv'])
sig = sig[(sig['NN_disc'] > -1)]
sig['isSignal'] = np.ones(len(sig))
bkg = build_background(['~/private/higgsToTauTau/ltau_analyzer/CMSSW_9_4_0/src/ltau_analyzers/Output/trees/mutau2016_official_v1p3_NNed/{}.root'.format(name) for name in 
  ['embedded', 'TTT', 'TTJ', 'ZJ', 'ZL', 'VVJ', 'VVT', 'W' ]])
